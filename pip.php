...
ob_start();
error_reporting(0);
define('API_KEY','5947136804:AAHKrJ3NcBkIYzrhjcPBZI27Urmcj2sFFHg');
...
@$usernamebot = "ALOFHbot"; //UserName Bot
@$channel = "A_S_S_A_A"; // UserName Channel don't @
@$token = API_KEY;
...
else
{
	bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"⚠️┇خطأ لا يمكن تحذير الادمن  , المدير  , الامبراطور ",
  'reply_to_message_id'=>$message_id,
'reply_markup'=>$inlinebutton,
 ]);
}
...
bot("sendmessage",[
"chat_id"=>$chat_id,
"text" => "✓ تم اضافت كليشة الامبراطور 🚀 
 -",'parse_mode'=>"MARKDOWN",
 'reply_to_message_id'=>$message_id
,]);}
if($text == "المطور" ){
...
🗯¦ الامبراطور : لعرض معلومات الامبراطور 
🗯¦ ايدي :↜لعرض معلوماتك  
