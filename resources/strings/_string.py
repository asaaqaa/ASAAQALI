...
Start = (
    """
    <------------------------------------>
         يتم تحميل ملفات السورس  ™الامبراـ𝄞ꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋ𝆫ــطور ™
    <------------------------------------>
    """
)
...
C = "**⌔╎المعادله ⪼** {}\n  **- الحل ⪼** {}"
Calc = (
    "𓆰 𝗦𝗢𝗨𝗥𝗖𝗘 B𝞝R - 𝑪𝑨𝑳𝑪𝑼𝑳𝑨𝑻𝑶𝑹 𓆪\n"
    "◐━─━─━─━─**B𝞝R**─━─━─━─━◐\n"
    "**⌔╎قائـمه اوامر الحاسبه :** \n"
    "⪼ `.حاسبه` + المعادله \n"
    "◐━─━─━─━─**B𝞝R**─━─━─━─━◐\n"
    "𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝙕𝞝𝘿 - [𝘿𝙀𝙑](t.me/kapo00s) 𓆪"
)
...
⫷ بوت ™الامبراـ𝄞ꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋ𝆫ــطور ™ يعمل بنجاح الان ⫸
   ⫷ المستخدم: {} - البوت: {} ⫸
...
Mesg = [
    '⫷ يتم تحميل انلاين ™الامبراـ𝄞ꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋ𝆫ــطور ™ ⫸',
    '⫷ اكتمل تنزيل انلاين ™الامبراـ𝄞ꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋ𝆫ــطور ™ بدون اخطاء ⫸',
    '⫷ يتم بدء بوت ™الامبراـ𝄞ꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋ𝆫ــطور ™ ⫸',
    '⫷ اكتمل بدء بوت ™الامبراـ𝄞ꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋ𝆫ــطور ™ ⫸'
]
