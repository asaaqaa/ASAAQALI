...
#
# This file is a part of < https://github.com/asaaqaa/ZED_USERBOT/ >
# PLease read the GNU Affero General Public License in
# <https://www.github.com/asaaqaa/ZED_USERBOT/blob/master/LICENSE/>.
...
# All Rights Reserved for "Zedthon - UserBot" "زلـزال الهيبـه ♕الأمبراطــور♕"
...
async def _(event):
    if event.fwd_from:
        return
   # All Rights Reserved for "asaaqaa - UserBot" "زلـزال الهيبـه ♕الأمبراطــور♕"
    res = ""
...
async def zelzal(zed):
    ...
    if con != "طرد":
        ...
        async for user in zed.client.iter_participants(zed.chat_id):
            if user.bot:
                ...
                await sleep(0.5)
        if del_u > 0:
            del_status = f"🛂**┊كشـف البـوتات -** 𝙎𝙊𝙐𝙍𝘾𝞝 BR𝞝TO♕الأمبراطــور♕\
    ...
    if del_a > 0:
        del_status = f"❇️**┊طـرد البـوتات -** 𝙎𝙊𝙐𝙍𝘾𝞝 BR𝞝TO♕الأمبراطــور♕\
