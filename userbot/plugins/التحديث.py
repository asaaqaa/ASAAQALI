...
async def print_changelogs(event, ac_br, changelog):
    changelog_str = f"𓆰 𝗦𝗢𝗨𝗥𝗖𝗘 B𝞝R - 𝑼𝑷𝑫𝑨𝑻𝑬 𝑴𝑺𝑮 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n** ⪼ يوجـد تحـديث جديد لسورس الأمبراطور  ༗.**\n\n`{changelog}`\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n 𓆰 𝙎𝙊𝙐𝙍𝘾𝞝 𝘿𝙀𝙑 - @kapo00s 𓆪"
...
async def deploy(event, repo, ups_rem, ac_br, txt):
    if HEROKU_API_KEY is not None:
        ...
        if heroku_app is None:
            await event.edit(f"{txt}\n" "بيانات اعتماد هيروكو غير صالحة لتنصيب الامبراطور")
            return repo.__del__()
        await event.edit(
            "**تنصيب تحديث الامبراطور قيد التقدم ، يرجى الانتظار حتى تنتهي العملية ، وعادة ما يستغرق التحديث من 4 إلى 5 دقائق.**"
        )
        ups_rem.fetch(ac_br)
...
async def update(event, repo, ups_rem, ac_br):
    ...
    await event.edit(
        "𓆰 𝗦𝗢𝗨𝗥𝗖𝗘 B𝞝R - 𝑼𝑷𝑫𝑨𝑻𝑬 𝑴𝑺𝑮 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n**⪼ تم التحديث بنجاح ✅**\n ** جارٍ إعادة تشغيل بوت الامبراطور ، انتظر 𓆰.**"
    )
...
async def upstream(event):
    "بالنسبة لأمر التحديث ، تحقق مما إذا كان بوت الامبراطور  محدثًا ، أو قم بالتحديث إذا تم بتحديثه"
    conf = event.pattern_match.group(1).strip()
    event = await edit_or_reply(
        event,
        "𓆰 𝑺𝑶𝑼𝑹𝑪𝑬 الامبراطور - 𝑼𝑷𝑫𝑨𝑻𝑬 𝑴𝑺𝑮 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n**⪼ جاري البحث عن التحديثات  🌐.. 𓆰،**",
    )
    ...
    if changelog == "" and not force_update:
        await event.edit(
            "\n𓆰 𝗦𝗢𝗨𝗥𝗖𝗘 B𝞝R  - 𝑼𝑷𝑫𝑨𝑻𝑬 𝑴𝑺𝑮 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n**⪼ سورس الامبراطور محدث لأخر اصدار ༗. **"
        )
        return repo.__del__()
