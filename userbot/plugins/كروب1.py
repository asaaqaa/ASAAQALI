...
async def _(event):
    if event.fwd_from:
        return
    mentions = "𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 BR𝞝TO♕الأمبراطــور♕ 𝑮𝑹𝑶𝑼𝑷 𝑫𝑨𝑻𝑨 𓆪\n** ⪼ المشرفـون في ۿذه المجموعه :** \n"
    reply_message = None
    ...
    if input_str:
        mentions_heading = (
            "𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 BR𝞝TO♕الأمبراطــور♕ 𝑮𝑹𝑶𝑼𝑷 𝑫𝑨𝑻𝑨 𓆪\n**⪼ مشرفـون في {} المجموعه :** \n".format(
                input_str
            )
        )
...
async def get_users(show):
    if show.fwd_from:
        return
    mentions = "𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 BR𝞝TO♕الأمبراطــور♕ 𝑮𝑹𝑶𝑼𝑷 𝙏𝘼𝙂 𓆪\n**⪼ هييه تعالـو يحبابين**  𓎤: \n"
    reply_to_id = None
...
𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"""
    ...
    await et.edit(
        """𓆰 𝑺𝑼𝑹𝑪𝑬 BR𝞝TO♕الأمبراطــور♕  - 𝑮𝑹𝑼𝑶𝑷 𝑺𝑻𝑨𝑻𝑺 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻
⪼ **العدد ↫ {} **مستخدماً
⪼ **الحسابات المحذوفه ↫** {}
⪼ **اخر ظهور منذ زمن طويل ↫** {}
⪼ **اخر ظهور منذ شهر ↫** {}
...
async def fetch_info(chat, event):
    ...
    caption = "<b> 𓆰 𝑺𝑶𝑼𝑹𝑪𝑬 BR𝞝TO♕الأمبراطــور♕  - 𝑮𝑹𝑼𝑶𝑷 𝑫𝑨𝑻𝑨 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 </b>\n"
    ...
    if hasattr(chat_obj_info, "scam") and chat_obj_info.scam:
        ...
        caption = f"<b>𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝘿𝙀𝙑 - @A_S_S_A_A 𓆪</b>"
    return caption
